...
urlpatterns = [
                  ...
                  url(r'^customers/(?P<customer_id>\d+)/remove', views.customers_remove, name='customers-remove'),
                  url(r'^groups$', views.groups_list, name='groups-list'),
                  url(r'^groups/(?P<group_id>\d+)/edit$', views.groups_edit, name='groups-edit'),
                  url(r'^groups/(?P<group_id>\d+)/remove$', views.groups_remove, name='groups-remove'),
                  ...
                  url(r'^groups/(?P<group_id>\d+)/members$', views.group_members,
                      name='group-members'),
